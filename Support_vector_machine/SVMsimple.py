...
# important parameter for SVC: gamma and C
# gamma -----> defines how far the influence f single training example reaches
            # low: influence reaches far       high: influence reaches close
# C ----> trades off the hyperplane surface simplicity + training examples mis-classification
            # Low value : simple/ smooth hyperplane
            # high value : all training examples classified correctly but complex surface


classifier = svm.SVC(C=3)
classifier.fit(X,y)
